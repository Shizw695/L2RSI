...
## 🛰️ Dataset Overview
The LiRSI dataset family is developed and released by [spAital Sensing and Computing Lab](https://asc.xmu.edu.cn/), Xiamen University.

[**LiRSI-XA**] is a cross-modal dataset designed for research on LiDAR place recognition based on satellite imagery. The point cloud data was collected using Ouster OS1-64 LiDAR in Xiang'an District, Xiamen, with a trajectory mileage of approximately **100km**. The resolution of original satellite imagery is **0.5m**, uniformly cropped into submaps of **60m x 60m**, with two-thirds overlap between adjacent submaps.
